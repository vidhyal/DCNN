...
cmd:option('--trainPath', '', 'path to training images (defaults to opt.dataPath/train)')
cmd:option('--validPath', '', 'path to validation images (defaults to opt.dataPath/val)')
...
cmd:option('--forReal', true, 'move everything for real')
...
opt.trainPath = opt.trainPath == '' and paths.concat(opt.dataPath,'train') or opt.trainPath
opt.validPath = opt.validPath == '' and paths.concat(opt.dataPath,'val') or opt.validPath
